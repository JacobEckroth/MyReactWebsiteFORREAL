    ...
    return (
      ...
      >
        <div class="linkHolder">
          <a className="outerGithubLink" href={this.state.githubLink} rel="noreferrer" target="_blank" title="Github Repository"><svg
          ...
          <a className="outerYoutubeLink" title="Youtube Demo Video" href={this.state.youtubeLink} rel="noreferrer" target="_blank">
          <svg
